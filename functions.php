...
// Setup Theme
add_action( 'after_setup_theme', 'newshealth_setup' );
function newshealth_setup(): void {
	 ...
	 */
	load_theme_textdomain( 'newshealth', get_parent_theme_file_path( '/languages' ) );
    ...
    register_nav_menus(
        array(
            'primary'   => esc_html__('Primary Menu', 'newshealth'),
        )
    );
