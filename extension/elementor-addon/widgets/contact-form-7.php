...
class Clinic_Elementor_Contact_Form_7 extends Widget_Base {
    ...
    public function get_name(): string {
        return 'newshealth-contact-form-7';
    }

    public function get_title(): string {
        return esc_html__( 'Contact Form 7', 'newshealth' );
    }
    ...
    protected function register_controls(): void {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Contact Form', 'newshealth' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__( 'Bảo  mật thông tin tuyệt đối', 'newshealth' ),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'show_gradient',
            [
                'label' => esc_html__( 'Show Gradient', 'newshealth' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'newshealth' ),
                'label_off' => esc_html__( 'Hide', 'newshealth' ),
                'return_value' => 'yes',
                'default' => '',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Chiều cao textarea', 'newshealth' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', 'custom' ],
                'range' => [
                    'px' => [
