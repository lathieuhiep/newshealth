...
class Clinic_Elementor_Heading_Between_Line extends Widget_Base
{
	...
	{
		return 'newshealth-heading-between-line';
	}
	...
	{
		return esc_html__('Heading Between Line', 'newshealth');
	}
	...
	protected function register_controls(): void
	{
		...
		$this->add_control(
			'heading',
			[
				'label' => esc_html__( 'Heading', 'newshealth' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Default title', 'newshealth' ),
				'placeholder' => esc_html__( 'Type your title here', 'newshealth' ),
				'label_block' => true
			]
		);
		...
		$this->add_responsive_control(
			'content_width',
			[
				'label' => esc_html__( 'Chiều rộng vùng chứa', 'newshealth' ),
		...
		$this->start_controls_section(
			'style_line_section',
			[
				'label' => esc_html__( 'Line', 'newshealth' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
