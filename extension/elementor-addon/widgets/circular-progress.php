...
class Clinic_Elementor_Circular_Progress extends Widget_Base
{
    ...
    {
        return 'newshealth-circular-progress';
    }
    ...
    {
        return esc_html__('Thanh tiến độ hình tròn', 'newshealth');
    }
    ...
    protected function register_controls(): void
    {
        ...
        $repeater->add_control(
            'list_percent',
            [
                'label' => esc_html__( 'Phần trăm', 'newshealth' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 1,
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Hình tròn', 'newshealth' ),
        ...
        $this->add_responsive_control(
            'circle_width',
            [
                'label' => esc_html__( 'Độ rộng hình tròn', 'newshealth' ),
                'type' => Controls_Manager::SLIDER,
        ...
        $this->add_control(
            ...
            [
                'label'     =>  esc_html__( 'Màu hình tròn 2', 'newshealth' ),
                'type'      =>  Controls_Manager::COLOR,
                'selectors' =>  [
